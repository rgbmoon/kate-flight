...
export async function handler(event, context) {
  ...
  const API_WALL_ENDPOINT = `https://api.vk.com/method/photos.get?owner_id=-${REACT_APP_VK_OWNER_ID}&album_id=277311524&rev=1&count=${count}&offset=${offset}&access_token=${REACT_APP_VK_SERVICE_KEY}&v=${REACT_APP_VK_API_VER}`
